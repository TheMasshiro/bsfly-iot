...
import { analyticsOutline, analyticsSharp, bugOutline, exitOutline, exitSharp, gridOutline, gridSharp, hardwareChipOutline, hardwareChipSharp, informationCircleOutline, informationCircleSharp, saveOutline, saveSharp, sunnyOutline, sunnySharp } from 'ionicons/icons';
import './Menu.css';
